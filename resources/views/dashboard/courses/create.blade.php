                ...
                <div class="card">
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <form class="form" action="{{ route('dashboard.courses.store') }}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                 <label>هل الدورة مميزة؟</label>
                                                    ...
                                                    <input type="checkbox" name="is_featured" class="form-control" value="1"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mt-2 text-center">
                                                    ...
                                                    <img id="imagePreview" src="{{ asset('default.png') }}"
