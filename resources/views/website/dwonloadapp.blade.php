...
@section('meta_title', $global_seo['download app']?->getTranslation('meta_title', app()->getLocale()) ?? 'Download App')
@section('meta_description', $global_seo['download app']?->getTranslation('meta_description', app()->getLocale()) ?? 'Download our app now')
@section('meta_keywords', $global_seo['download app']?->getTranslation('meta_keywords', app()->getLocale()) ?? 'app download, gym food app')
...
@section('content')
    <section class="py-1" style="margin-top: 150px;">
        <div class="container
                ...
                <div class="col-12 col-sm-6 ">
                    ...
                    <li class="list-inline-item ms-4">
                        <a href="{{ $settings->app_store_link }}" target="_blank">
                            <img class="img-fluid" src="{{ asset('asset/website/assets/images/appstore.png') }}"
                                alt="">
                        </a>
                    </li>
                    ...
                    <li class="list-inline-item">
                        <a href="{{ $settings->google_play_link }}" target="_blank">
                            <img class="img-fluid" src="{{ asset('asset/website/assets/images/googleplay.png') }}"
                                alt="">
                        </a>
                    </li>
                </div>
