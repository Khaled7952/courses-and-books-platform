        ...
        <div class="invoice-body">
                    ...
                    <tbody>
                        @forelse($items as $item)
                            <tr>
                                ...
                                <td class="text-center">دورة</td>
                                <td class="text-end fw-bold">{{ number_format((float)$item->price, 2) }} SAR</td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="3" class="py-4 text-center text-muted">
                                    لا توجد دورات داخل هذا الطلب
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
            ...
            <div class="invoice-footer">
                <a href="{{ route('profile') }}" class="px-4 btn btn-primary">
                    الانتقال للصفحة الشخصية لمشاهدة الدورات
                </a>

                <a href="{{ route('courses.index') }}" class="px-4 btn btn-outline-dark">
                    تصفح دورات أخرى
                </a>
            </div>
        </div>
